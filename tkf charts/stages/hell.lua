function onCreatePost()
    makeLuaSprite('tymek/hell', 'tymek/hell', -3000, -2000);
    setLuaSpriteScrollFactor('tymek/hell', 1, 1);
    scaleObject('tymek/hell', 6, 6);
	addGlitchEffect('tymek/hell', 16, 64);
    addLuaSprite('tymek/hell', false)
end
